...
def mock_buffer_db(monkeypatch):
    ...
    monkeypatch.setattr('pos_monitor.app.config.BUFFER_DB_PATH', str(temp_db_path))
    monkeypatch.setattr('pos_monitor.app.database.BUFFER_DB_PATH', str(temp_db_path))
